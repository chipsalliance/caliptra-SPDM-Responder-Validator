...
Steps:
1. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1.Sig=(MEAS_CAP == 2), Param2=NumberOfMeasurements, SlotID=ValidSlotID[i], RequesterContext=RandomBytes}
2. SpdmMessage <- Responder
...
Assertion 7.11.7:
    SpdmMessage.Param2.SlotID == ValidSlotID[i] &&
    (SpdmMessage.Param2.ContentChanged == NotSupported || SpdmMessage.Param2.ContentChanged == NoChange), if MEAS_CAP == 2
    SPDMsignatureVerify (PubKey, SpdmMessage.Signature, L1/L2) version 1.4 success, if Flags.MEAS_CAP == 2

3. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1.Sig=(MEAS_CAP == 2), Param2=AllMeasurements, SlotID=ValidSlotID[i], RequesterContext=RandomBytes}
4. SpdmMessage <- Responder
...
5. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1=0, Param2=ValidMeasurementIndex[i], SlotID=ValidSlotID[i], RequesterContext=RandomBytes}, if i < NumberOfMeasurements - 1
6. SpdmMessage <- Responder
...
7. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1.Sig=(MEAS_CAP == 2), Param2=ValidMeasurementIndex[NumberOfMeasurements - 1], SlotID=ValidSlotID[i], RequesterContext=RandomBytes}
8. SpdmMessage <- Responder

Assertion 7.11.{15~20}
...
Assertion 7.11.22:
    The first MEASUREMENTS.RequesterContext == the first GET_MEASUREMENTS.RequesterContext

Assertion 7.11.23:
    The all-measurements MEASUREMENTS.RequesterContext == the corresponding GET_MEASUREMENTS.RequesterContext

Assertion 7.11.24:
    Each one-by-one MEASUREMENTS.RequesterContext == the corresponding GET_MEASUREMENTS.RequesterContext

### Case 7.12

Description: SPDM responder shall return valid MEASUREMENTS, if it receives a GET_MEASUREMENTS in a DHE session with negotiated version 1.4.
...
Steps:
1. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1.Sig=(MEAS_CAP == 2), Param2=NumberOfMeasurements, SlotID=ValidSlotID[i], RequesterContext=RandomBytes} in session-X
2. SpdmMessage <- Responder in session-X
...
3. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1.Sig=(MEAS_CAP == 2), Param2=AllMeasurements, SlotID=ValidSlotID[i], RequesterContext=RandomBytes} in session-X
4. SpdmMessage <- Responder in session-X
...
5. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1=0, Param2=ValidMeasurementIndex[i], SlotID=ValidSlotID[i], RequesterContext=RandomBytes} in session-X, if i < NumberOfMeasurements - 1
6. SpdmMessage <- Responder in session-X
...
7. Requester -> GET_MEASUREMENTS {SPDMVersion=NegotiatedVersion, Param1.Sig=(MEAS_CAP == 2), Param2=ValidMeasurementIndex[NumberOfMeasurements - 1], SlotID=ValidSlotID[i], RequesterContext=RandomBytes} in session-X
8. SpdmMessage <- Responder in session-X

Assertion 7.12.{15~20}
