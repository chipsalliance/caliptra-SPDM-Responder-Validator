...
Assertion 3.9.11:
    ...
    SpdmMessage.AlgStructure[i].AlgType is in {DHE, AEAD, ReqBaseAsymAlg, KeySchedule, ReqPqcAsymAlg, KemAlg} and no duplication.
...
Assertion 3.9.20:
    ...
    if (KEY_EX_CAP == 1) then SpdmMessage.AlgStructure[KemAlg_index].AlgSupported == one of {ML_KEM_512, ML_KEM_768, ML_KEM_1024} or KemAlg == 0
    if (KEY_EX_CAP == 0) then SpdmMessage.AlgStructure[KemAlg_index].AlgSupported == 0, or it is absent
