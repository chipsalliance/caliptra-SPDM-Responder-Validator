...
Description: SPDM responder shall return valid ALGORITHMS(0x14), if it receives a GET_ALGORITHMS with negotiated version 1.4.
...
4. Requester -> GET_CAPABILITIES {SPDMVersion=0x14, ...}
5. CAPABILITIES <- Responder

TestTeardown: None

Steps:
1. Requester -> NEGOTIATE_ALGORITHMS {SPDMVersion=0x14, Param1.NumOfAlgoStruct=6, Param2=0, MeasurementSpecification=DMTF, OtherParamsSupport=OpaqueDataFmt1, BaseAsymAlgo=TPM_ALG_RSASSA_2048|TPM_ALG_RSAPSS_2048|TPM_ALG_RSASSA_3072|TPM_ALG_RSAPSS_3072|TPM_ALG_ECDSA_ECC_NIST_P256|TPM_ALG_RSASSA_4096|TPM_ALG_RSAPSS_4096|TPM_ALG_ECDSA_ECC_NIST_P384|TPM_ALG_ECDSA_ECC_NIST_P521|TPM_ALG_SM2_ECC_SM2_P256|EdDSA_ed25519|EdDSA_ed448, BaseHashAlgo=TPM_ALG_SHA_256|TPM_ALG_SHA_384|TPM_ALG_SHA_512|TPM_ALG_SHA3_256|TPM_ALG_SHA3_384|TPM_ALG_SHA3_512|TPM_ALG_SM3_256, PqcAsymAlgo=ML_DSA_44|ML_DSA_65|ML_DSA_87|SLH_DSA_SHA2_128S|SLH_DSA_SHAKE_128S|SLH_DSA_SHA2_128F|SLH_DSA_SHAKE_128F|SLH_DSA_SHA2_192S|SLH_DSA_SHAKE_192S|SLH_DSA_SHA2_192F|SLH_DSA_SHAKE_192F|SLH_DSA_SHA2_256S|SLH_DSA_SHAKE_256S|SLH_DSA_SHA2_256F|SLH_DSA_SHAKE_256F, ExtAsymCount=0, ExtHashCount=0, ReqAlgStruct[0]{AlgType=DHE, AlgSupported=ffdhe2048|ffdhe3072|ffdhe4096|secp256r1|secp384r1|secp521r1|SM2_P256}, ReqAlgStruct[1]{AlgType=AEAD, AlgSupported=AES-128-GCM|AES-256-GCM|CHACHA20_POLY1305|AEAD_SM4_GCM}, ReqAlgStruct[2]{AlgType=ReqBaseAsymAlg, AlgSupported=TPM_ALG_RSASSA_2048|TPM_ALG_RSAPSS_2048|TPM_ALG_RSASSA_3072|TPM_ALG_RSAPSS_3072|TPM_ALG_ECDSA_ECC_NIST_P256|TPM_ALG_RSASSA_4096|TPM_ALG_RSAPSS_4096|TPM_ALG_ECDSA_ECC_NIST_P384|TPM_ALG_ECDSA_ECC_NIST_P521|TPM_ALG_SM2_ECC_SM2_P256|EdDSA_ed25519|EdDSA_ed448}, ReqAlgStruct[3]{AlgType=KeySchedule, AlgSupported=SPDM}, ReqAlgStruct[4]{AlgType=ReqPqcAsymAlg, AlgSupported=ML_DSA_44|ML_DSA_65|ML_DSA_87|SLH_DSA_SHA2_128S|SLH_DSA_SHAKE_128S|SLH_DSA_SHA2_128F|SLH_DSA_SHAKE_128F|SLH_DSA_SHA2_192S|SLH_DSA_SHAKE_192S|SLH_DSA_SHA2_192F|SLH_DSA_SHAKE_192F|SLH_DSA_SHA2_256S|SLH_DSA_SHAKE_256S|SLH_DSA_SHA2_256F|SLH_DSA_SHAKE_256F}, ReqAlgStruct[5]{AlgType=KemAlg, AlgSupported=ML_KEM_512|ML_KEM_768|ML_KEM_1024} }
2. SpdmMessage <- Responder
...
Assertion 3.9.9:
    SpdmMessage.BaseAsymSel only has one bit at most.
    The total number of bits set across BaseAsymSel and PqcAsymSel shall be no more than one.
    if (CHAL_CAP == 1 || MEAS_CAP == 2 || KEY_EX_CAP == 1) then (BaseAsymSel == one of {TPM_ALG_RSASSA_2048, TPM_ALG_RSAPSS_2048, TPM_ALG_RSASSA_3072, TPM_ALG_RSAPSS_3072, TPM_ALG_ECDSA_ECC_NIST_P256, TPM_ALG_RSASSA_4096, TPM_ALG_RSAPSS_4096, TPM_ALG_ECDSA_ECC_NIST_P384, TPM_ALG_ECDSA_ECC_NIST_P521, TPM_ALG_SM2_ECC_SM2_P256, EdDSA_ed25519, EdDSA_ed448} or BaseAsymSel == 0 if PqcAsymSel != 0)
    if (CHAL_CAP == 0 && MEAS_CAP != 2 && KEY_EX_CAP == 0) then (BaseAsymSel == 0)
...
Assertion 3.9.11:
    SpdmMessage.Param1 <= 6
    SpdmMessage.AlgStructure[i].AlgType is in {DHE, AEAD, ReqBaseAsymAlg, KeySchedule, ReqPqcAsymAlg, KemAlg} and is strictly increasing, which also prevents duplication.
...
Assertion 3.9.13:
    SpdmMessage.AlgStructure[DHE_index] only has one bit at most.
    if (KEY_EX_CAP == 1) then SpdmMessage.AlgStructure[DHE_index].AlgSupported is either one of {ffdhe2048, ffdhe3072, ffdhe4096, secp256r1, secp384r1, secp521r1, SM2_P256}, or 0 when KemAlg is selected.
    if (KEY_EX_CAP == 0) then SpdmMessage.AlgStructure[DHE_index].AlgSupported == 0, or it is absent
...
Assertion 3.9.15:
    SpdmMessage.AlgStructure[ReqBaseAsymAlg_index] only has one bit at most.
    The total number of bits set across ReqBaseAsymAlg and ReqPqcAsymAlg shall be no more than one.
    if (MUT_AUTH_CAP == 1) then SpdmMessage.AlgStructure[ReqBaseAsymAlg_index].AlgSupported == one of {TPM_ALG_RSASSA_2048, TPM_ALG_RSAPSS_2048, TPM_ALG_RSASSA_3072, TPM_ALG_RSAPSS_3072, TPM_ALG_ECDSA_ECC_NIST_P256, TPM_ALG_RSASSA_4096, TPM_ALG_RSAPSS_4096, TPM_ALG_ECDSA_ECC_NIST_P384, TPM_ALG_ECDSA_ECC_NIST_P521, TPM_ALG_SM2_ECC_SM2_P256, EdDSA_ed25519, EdDSA_ed448} or ReqBaseAsymAlg == 0 if ReqPqcAsymAlg != 0
    if (MUT_AUTH_CAP == 0) then SpdmMessage.AlgStructure[ReqBaseAsymAlg_index].AlgSupported == 0, or it is absent
...
Assertion 3.9.18:
    SpdmMessage.PqcAsymSel only has one bit at most.
    The total number of bits set across BaseAsymSel and PqcAsymSel shall be no more than one.
    if (CHAL_CAP == 1 || MEAS_CAP == 2 || KEY_EX_CAP == 1) then (PqcAsymSel == one of {ML_DSA_44, ML_DSA_65, ML_DSA_87, SLH_DSA_SHA2_128S, SLH_DSA_SHAKE_128S, SLH_DSA_SHA2_128F, SLH_DSA_SHAKE_128F, SLH_DSA_SHA2_192S, SLH_DSA_SHAKE_192S, SLH_DSA_SHA2_192F, SLH_DSA_SHAKE_192F, SLH_DSA_SHA2_256S, SLH_DSA_SHAKE_256S, SLH_DSA_SHA2_256F, SLH_DSA_SHAKE_256F} or PqcAsymSel == 0)
    if (CHAL_CAP == 0 && MEAS_CAP != 2 && KEY_EX_CAP == 0) then (PqcAsymSel == 0)

Assertion 3.9.19:
    SpdmMessage.AlgStructure[ReqPqcAsymAlg_index] only has one bit at most.
    The total number of bits set across ReqBaseAsymAlg and ReqPqcAsymAlg shall be no more than one.
    if (MUT_AUTH_CAP == 1) then SpdmMessage.AlgStructure[ReqPqcAsymAlg_index].AlgSupported == one of {ML_DSA_44, ML_DSA_65, ML_DSA_87, SLH_DSA_SHA2_128S, SLH_DSA_SHAKE_128S, SLH_DSA_SHA2_128F, SLH_DSA_SHAKE_128F, SLH_DSA_SHA2_192S, SLH_DSA_SHAKE_192S, SLH_DSA_SHA2_192F, SLH_DSA_SHAKE_192F, SLH_DSA_SHA2_256S, SLH_DSA_SHAKE_256S, SLH_DSA_SHA2_256F, SLH_DSA_SHAKE_256F} or ReqPqcAsymAlg == 0
    if (MUT_AUTH_CAP == 0) then SpdmMessage.AlgStructure[ReqPqcAsymAlg_index].AlgSupported == 0, or it is absent

Assertion 3.9.20:
    SpdmMessage.AlgStructure[KemAlg_index] only has one bit at most.
    if (KEY_EX_CAP == 1) then exactly one of DHE and KemAlg is selected. KemAlg, when selected, is one of {ML_KEM_512, ML_KEM_768, ML_KEM_1024}.
    if (KEY_EX_CAP == 0) then both DHE and KemAlg are 0 or absent.
