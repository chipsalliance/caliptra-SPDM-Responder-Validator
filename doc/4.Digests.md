...
Assertion 4.1.4:
    if (NegotiatedVersion < 1.3) {
        SpdmMessage.Param1 == 0
    } else {
        SpdmMessage.Param2.ProvisionedSlotMask != 0
        (SpdmMessage.Param1.SupportedSlotMask & SpdmMessage.Param2.ProvisionedSlotMask) == SpdmMessage.Param2.ProvisionedSlotMask
    }
